...
class ExtendDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', fn($row) => view('check-ins.extend.action', compact('row')))
    ...
    {
        return 'ExtendStay_' . date('YmdHis');
    }
}
