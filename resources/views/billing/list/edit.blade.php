<x-app-layout>
    <x-form.layout :form="$form ?? null" :action="route('billing.list.edit', $invoice->id)" method="PATCH">
        <div class="container-fluid py-3">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-primary text-white">
                            <h4 class="card-title mb-0">{{ __('billing.edit_invoice') }} - {{ $invoice->invoice_number }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <x-form.select
                                        ...
                                        :options="[
                                            ...
                                            'unpaid' => __('billing.unpaid'),
                                            'partially_paid' => __('billing.partially_paid'),
                                            'overdue' => __('billing.overdue')
                                        ]"
                                        :selected="old('status', $invoice->status)"
                                        required
                                    />
                                </div>
                                <div class="col-md-6">
                                    <x-form.textarea
                                        :label="__('billing.notes')"
                                        name="notes"
                                        :value="old('notes', $invoice->notes)"
                                        rows="3"
                                        :placeholder="__('billing.notes')"
                                    />
                                </div>
                            </div>
                    ...
                    <div class="text-end">
                        <x-form.button-back :href="route('billing.list.index')" />
