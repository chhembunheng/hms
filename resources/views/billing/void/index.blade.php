<x-app-layout>
            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">{{ __('billing.void_invoices') }}</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('billing.void.edit', $invoice->id) }}" class="btn btn-sm btn-outline-warning" title="{{ __('billing.edit_invoice') }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-outline-danger" title="{{ __('billing.delete_invoice') }}"
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <p>{{ __('billing.no_void_invoices') }}</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('billing.delete_void_invoice') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <p>{{ __('billing.delete_void_invoice_confirmation') }}</p>
    ...
    function confirmDelete(invoiceId, invoiceNumber) {
        ...
        document.getElementById('deleteForm').action = '{{ url("billing/void") }}/' + invoiceId + '/delete';
