        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="contact-form">
                    ...
                    <form id="contact-form" class="contact-form form" action="{{ route('frontend.contact.submit', ['locale' => app()->getLocale()]) }}" method="POST" error-message="{{ __('global.contact_form_error_message') }}">
                        @csrf
                        <div class="row">
