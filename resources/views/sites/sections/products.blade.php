                    ...
                    <div class="{{ $colClass }}">
                        <article class="project-item">
                            ...
                            <div class="project-content-overlay">
                                ...
                                <a class="project-link-btn" href="{{ Route::has('frontend.products') ? route('frontend.products', ['locale' => app()->getLocale(), 'slug' => $product->slug]) : '#' }}" aria-label="View Product {{ $product->name }}">{{ __('global.view_product') }}</a>
                            </div>
                        </article>
                    </div>
                @endforeach
