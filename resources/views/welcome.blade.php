<x-frontend-layout>
    ...
    @if (isset($articles) && !isset($article))
        @include('sites.sections.articles', [
            'articles' => $articles,
            'title' => __('global.article'),
            'subtitle' => __('global.latest_post_from_article'),
        ])
    @endif
    @isset($article)
        @php
        ...
        @endphp
        @include('sites.sections.article', [
            'articles' => $articles,
            'article' => $article,
            'title' => __('global.article'),
            'subtitle' => __('global.latest_post_from_article'),
    ...
    @endisset
    @isset($service)
        @include('sites.sections.service', [
            'services' => $services,
            'service' => $service,
            'title' => $area['title'],
    ...
    @if (isset($services) && !isset($service))
        @include('sites.sections.services', [
            'services' => $services,
            'title' => __('global.our_services'),
            'subtitle' => __('global.what_we_offer'),
        ])
    @endif
    @isset($achievements)
        @include('sites.sections.achievements', [
            'achievements' => $achievements,
            'title' => __('global.our_achievements'),
            'subtitle' => __('global.what_we_have_accomplished'),
        ])
    @endisset
    @isset($teams)
        @include('sites.sections.teams', [
            'teams' => $teams,
    ...
    @if (isset($integrations) && !isset($integration))
        @include('sites.sections.integrations', [
            'integrations' => $integrations,
            'title' => __('global.our_integrations'),
            'subtitle' => __('global.connect_your_favorite_tools'),
        ])
    @endif
    @isset($integration)
        @include('sites.sections.integration', [
    ...
    @endisset
    @isset($contacts)
        @include('sites.sections.contact', [
            'contacts' => $contacts,
            'title' => __('global.get_in_touch'),
            'subtitle' => __('global.contact_us'),
        ])
    @endisset
    @isset($choosing)
        @include('sites.sections.choosing', [
            'choosing' => $choosing,
            'title' => __('global.why_choose_us'),
            'subtitle' => __('global.best_reason_to_choose_us'),
        ])
    @endisset
    @isset($talk)
        @include('sites.sections.talk', [
            'title' => __('global.let_s_talk'),
