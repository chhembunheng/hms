...
<div class="offcanvas offcanvas-end" tabindex="-1" id="notifications">
    ...
    <div class="offcanvas-body p-0">
        <div class="fw-medium py-2 px-3">New notifications</div>
        <div class="p-3">
            <div class="d-flex align-items-start mb-3">
                <a href="index.html#" class="status-indicator-container me-3">
                    <img src="{{ asset('assets/images/default/male-avatar.jpg') }}" class="w-40px h-40px rounded-pill">
                    <span class="status-indicator bg-success"></span>
                </a>
                <div class="flex-fill">
                    <a href="index.html#" class="fw-semibold">James</a> has completed the task <a href="index.html#">Submit documents</a> from <a href="index.html#">Onboarding</a> list
            ...
            <div class="d-flex align-items-start mb-3">
                ...
                <div class="flex-fill">
                    <a href="index.html#" class="fw-semibold">Margo</a> has added 4 users to <span class="fw-semibold">Customer enablement</span> channel

                    <div class="d-flex my-2">
                        <a href="index.html#" class="status-indicator-container me-1">
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="flex-1">
                    Subscription <a href="index.html#">#466573</a> from 10.12.2021 has been cancelled. Refund case <a href="index.html#">#4492</a> created
        ...
        <div class="p-3">
            ...
            <div class="d-flex align-items-start mb-3">
                ...
                <div class="flex-fill">
                    <a href="index.html#" class="fw-semibold">Mike</a> added 1 new file(s) to <a href="index.html#">Product management</a> project
                    <div class="bg-light rounded p-2 my-2">
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <img src="{{ asset('assets/images/icons/pdf.svg') }}" width="34" height="34">
                            </div>
                            <div class="flex-fill">
                                new_contract.pdf
            ...
            <div class="d-flex align-items-start mb-3">
                ...
                <div class="flex-fill">
                    <a href="index.html#" class="fw-semibold">Christine</a> commented on your community <a href="index.html#">post</a> from 10.12.2021
                    <div class="fs-sm text-muted mt-1">2 days ago</div>
                </div>
            </div>
